...
```golang
ctx := context.WithValue(context.Background(), glinet.ContextServerIndex, 1)
```
...
```golang
ctx := context.WithValue(context.Background(), glinet.ContextServerVariables, map[string]string{
	"basePath": "v2",
})
```
...
```
ctx := context.WithValue(context.Background(), glinet.ContextOperationServerIndices, map[string]int{
	"{classname}Service.{nickname}": 2,
})
ctx = context.WithValue(context.Background(), glinet.ContextOperationServerVariables, map[string]map[string]string{
